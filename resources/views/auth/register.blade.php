...
@section('content')
<div class="container-fluid mt-3" style="width: 900px ;margin-bottom:120px">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" required autocomplete="address" autofocus>{{ old('address') }}</textarea>
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="prev_experi" class="col-md-4 col-form-label text-md-right">{{ __('Previous Experience') }}</label>
                            <div class="col-md-6">
                                <input id="prev_experi" type="text" class="form-control @error('prev_experi') is-invalid @enderror" name="prev_experi" value="{{ old('prev_experi') }}" required autocomplete="prev_experi" autofocus>
