...
<body>
    @php
    $carts = json_decode($details['cart'] );
@endphp
   
    <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 padding">
        <div class="card">
            <div class="card-header p-4">
                <a class="pt-2 d-inline-block" href="index.html" data-abc="true">http://albalaghulmubin.org/</a>
                <div class="float-right">
                    <h6 class="mb-0">Invoice #Al Blagul Mubin</h6>
                    Date: <?php
                       echo date("d/m/Y");
                       $i=1;
                    ?>
            ...
            <div class="card-body">
                <div class="row mb-4 d-flex">
                    ...
                    <div class="col-sm-6 text-end">
                        <h5 class="mb-3">To:</h5>
                        <h5 class="text-dark mb-1">Al Balagul-Mubin</h5>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="left strong">{{$cart->name}}</td>
